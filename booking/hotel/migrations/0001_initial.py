    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'client'), ('owner', 'owner'), ('admin', 'admin')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('доступно', 'доступно'), ('забронировано', 'забронировано'), ('оккупировано', 'оккупировано')], default='available', max_length=20)),
